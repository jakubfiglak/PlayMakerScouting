...
describe('POST /api/v1/reports', () => {
  it('should create a new report, add created report id to authors ACL and if the user belongs to a team, this teams ACL should also be populated with created report id, finally it should return created report with populated data', async () => {
